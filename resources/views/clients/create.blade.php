        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('clients.store') }}" class="max-w-2xl">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="gst_number" class="block mt-1 w-full uppercase" type="text" name="gst_number" :value="old('gst_number')" placeholder="22AAAAA0000A1Z5" />
